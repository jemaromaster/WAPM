...
class Informe(flask.views.MethodView):
    ...
    def get(self): 
        ...
        usuariosComite=sesion.query(Usuario).join(comiteProyectoTabla)\
                                    .filter(Proyecto.idProyecto==pr.idProyecto)\
                                    .filter(Usuario.activo=="true")
        sesion.close()
        
        
        html=''
        html=html+'<h1 align=center>Informe de Costos </h1><p><b>Motivo de Solicitud de Cambio</b>:'+sc.descripcion+'</p><p><b>Solicitante</b>: '+autor.apellidos+', '+autor.apellidos + ' ['+ autor.username   +   ']</p>'
